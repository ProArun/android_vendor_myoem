...
// libbinder + IBinder::FLAG_PRIVATE_VENDOR — same technique as BmiCalJni.cpp
// in BMICalculatorA. See that file for full explanation.
// Short version: FLAG_PRIVATE_VENDOR lowers BpBinder's required stability from
// LOCAL (system partition) to VENDOR, allowing these calls to reach
// VENDOR-stability services without BAD_TYPE (-2147483647).
...
Java_com_myoem_bmicalculator_BmiCalManager_isBmiAvailable(JNIEnv*, jobject) {
    return defaultServiceManager()->checkService(String16(kBmiSvc)) != nullptr
           ? JNI_TRUE : JNI_FALSE;
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_myoem_bmicalculator_BmiCalManager_isCalcAvailable(JNIEnv*, jobject) {
...
Java_com_myoem_bmicalculator_BmiCalManager_nativeAdd(
        JNIEnv* e, jobject, jint a, jint b) { return calcOp(e, TX_ADD, "add", a, b); }

extern "C" JNIEXPORT jint JNICALL
Java_com_myoem_bmicalculator_BmiCalManager_nativeSubtract(
        JNIEnv* e, jobject, jint a, jint b) { return calcOp(e, TX_SUBTRACT, "subtract", a, b); }

extern "C" JNIEXPORT jint JNICALL
Java_com_myoem_bmicalculator_BmiCalManager_nativeMultiply(
        JNIEnv* e, jobject, jint a, jint b) { return calcOp(e, TX_MULTIPLY, "multiply", a, b); }

extern "C" JNIEXPORT jint JNICALL
Java_com_myoem_bmicalculator_BmiCalManager_nativeDivide(
